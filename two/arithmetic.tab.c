...
#line 1069 "arithmetic.tab.c"
    break;

  case 3: /* expr: expr '-' expr  */
#line 26 "arithmetic.y"
                   { (yyval.node) = createNode(0, '-', (yyvsp[-2].node), (yyvsp[0].node)); }
#line 1075 "arithmetic.tab.c"
    break;

  case 4: /* expr: expr '*' expr  */
#line 27 "arithmetic.y"
                   { (yyval.node) = createNode(0, '*', (yyvsp[-2].node), (yyvsp[0].node)); }
#line 1081 "arithmetic.tab.c"
    break;

  case 5: /* expr: expr '/' expr  */
#line 28 "arithmetic.y"
                   { (yyval.node) = createNode(0, '/', (yyvsp[-2].node), (yyvsp[0].node)); }
#line 1087 "arithmetic.tab.c"
    break;

  case 6: /* expr: '-' expr  */
#line 29 "arithmetic.y"
                          { (yyval.node) = createNode(0, '-', NULL, (yyvsp[0].node)); }
#line 1093 "arithmetic.tab.c"
    break;

  case 7: /* expr: '(' expr ')'  */
#line 30 "arithmetic.y"
                   { (yyval.node) = (yyvsp[-1].node); }
#line 1099 "arithmetic.tab.c"
    break;

  case 8: /* expr: NUM  */
#line 31 "arithmetic.y"
                   { (yyval.node) = createNode((yyvsp[0].num), 0, NULL, NULL); }
#line 1105 "arithmetic.tab.c"
    break;


#line 1109 "arithmetic.tab.c"
