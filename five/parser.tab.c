...
static const char *const yytname[] =
{
  ...
  "ASSIGN", "SEMICOLON", "PLUS", "MINUS", "MULTIPLY", "DIVIDE", "LPAREN",
  "RPAREN", "$accept", "program", "statement", "expression", "term",
  "factor", YY_NULLPTR
};
...
{
     -11,     6,   -11,     8,   -11,    -3,   -11,   -11,    -3,     4,
       5,   -11,    -5,   -11,    -3,    -3,    -3,    -3,   -11,     5,
       5,   -11,   -11
};
...
{
       3,     0,     1,     0,     2,     0,    12,    11,     0,     0,
       5,     8,     0,     4,     0,     0,     0,     0,    13,     6,
       7,     9,    10
};
...
{
       6,     7,    14,    15,    19,    20,     2,    18,     8,     3,
      13,    14,    15,     5,    16,    17,    21,    22,    12
};

static const yytype_int8 yycheck[] =
{
       3,     4,     7,     8,    14,    15,     0,    12,    11,     3,
       6,     7,     8,     5,     9,    10,    16,    17,     8
};
...
{
       0,    14,     0,     3,    15,     5,     3,     4,    11,    16,
      17,    18,    16,     6,     7,     8,     9,    10,    12,    17,
      17,    18,    18
};
...
#line 41 "parser.y"
        ...
        (yyval.str) = strdup((yyvsp[-2].str)); // Simplified - you could implement actual computation logic here
        free((yyvsp[-2].str));
        free((yyvsp[0].str));
    }
...
#line 1116 "parser.tab.c"
  ...
  case 9: /* term: term MULTIPLY factor  */
#line 57 "parser.y"
                           {
        printf("Term: %s * %s\n", (yyvsp[-2].str), (yyvsp[0].str));
        (yyval.str) = strdup((yyvsp[-2].str));
